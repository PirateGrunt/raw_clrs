...
## Selected Loss Development Factors
This has the potential to support the variability calcaulation from the [CLFM paper](http://www.variancejournal.org/issues/06-02/143.pdf)

[Github issue](https://github.com/mages/ChainLadder/issues/23)


## Quarterly Triangles
The `qpaid` and `qincurred` are included in ChainLadder to demonstrate how to deal with triangles with quarterly evlautions and annual periods.
```{r}
# ?qpaid #not run
dim(qpaid)
